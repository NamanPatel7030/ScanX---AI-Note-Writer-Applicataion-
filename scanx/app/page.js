...
export default function Home() {
  ...
  {/* Mobile/Tablet Incompatibility Overlay */}
  <div className="md:hidden fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm z-50 flex items-center justify-center">
  {/* <Image
              src={"/scanx-logo.png"}
              alt="ScanX Logo"
              width={60}
              height={60}
            /> */}
    <p className="text-white text-center text-2xl px-6">
      ScanX is not compatible with mobile screens. Please open on a PC or Laptop.
    </p>
  </div>

  {/* Main Content - visible only on md and above */}
